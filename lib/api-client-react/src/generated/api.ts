...
import type {
  ...
  Registration,
  RegistrationDetail,
  RegistrationFamilyUpdateInput,
  RegistrationFamilyUpdateResult,
  RegistrationGroup,
  RegistrationInput,
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListEventCheckinsQueryKey(eventId);
   ...
   return  { queryKey, queryFn, enabled: eventId !== null && eventId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listEventCheckins>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListEventSessionsQueryKey(eventId);
   ...
   return  { queryKey, queryFn, enabled: eventId !== null && eventId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listEventSessions>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getCreateTodayEventSessionUrl = (eventId: number,) => {




  return `/api/events/${eventId}/sessions/today`
}

/**
 * @summary Create or return today's session for an event
 */
export const createTodayEventSession = async (eventId: number, options?: RequestInit): Promise<EventSession> => {

  return customFetch<EventSession>(getCreateTodayEventSessionUrl(eventId),
  {
    ...options,
    method: 'POST'
...
export const getCreateTodayEventSessionMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createTodayEventSession>>, TError,{eventId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createTodayEventSession>>, TError,{eventId: number}, TContext> => {

const mutationKey = ['createTodayEventSession'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createTodayEventSession>>, {eventId: number}> = (props) => {
          const {eventId} = props ?? {};

          return  createTodayEventSession(eventId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateTodayEventSessionMutationResult = NonNullable<Awaited<ReturnType<typeof createTodayEventSession>>>

    export type CreateTodayEventSessionMutationError = ErrorType<unknown>

    /**
 * @summary Create or return today's session for an event
 */
export const useCreateTodayEventSession = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createTodayEventSession>>, TError,{eventId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createTodayEventSession>>,
        TError,
        {eventId: number},
        TContext
      > => {
      return useMutation(getCreateTodayEventSessionMutationOptions(options));
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetFormBySlugQueryKey(embedSlug);
   ...
   return  { queryKey, queryFn, enabled: embedSlug !== null && embedSlug !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getFormBySlug>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListQuestionsQueryKey(formId);
   ...
   return  { queryKey, queryFn, enabled: formId !== null && formId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listQuestions>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListFormFieldsQueryKey(formId);
   ...
   return  { queryKey, queryFn, enabled: formId !== null && formId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listFormFields>>, TError, TData> & { queryKey: QueryKey }
}
...
export const reorderFormFields = async (formId: number,
  ...
  return customFetch<FormField[]>(getReorderFormFieldsUrl(formId),
  {
    ...
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(reorderFieldsInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListRegistrationsQueryKey(formId);
   ...
   return  { queryKey, queryFn, enabled: formId !== null && formId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listRegistrations>>, TError, TData> & { queryKey: QueryKey }
}
...
export const updateRegistration = async (registrationId: number,
  ...
  return customFetch<Registration>(getUpdateRegistrationUrl(registrationId),
  {
    ...
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(registrationUpdateInput)
  }
);}
...
export const getUpdateRegistrationFamilyUrl = () => {




  return `/api/registration-families`
}

/**
 * @summary Update shared family and guardian details for a set of registrations
 */
export const updateRegistrationFamily = async (registrationFamilyUpdateInput: RegistrationFamilyUpdateInput, options?: RequestInit): Promise<RegistrationFamilyUpdateResult> => {

  return customFetch<RegistrationFamilyUpdateResult>(getUpdateRegistrationFamilyUrl(),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(registrationFamilyUpdateInput)
  }
);}
...
export const getUpdateRegistrationFamilyMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateRegistrationFamily>>, TError,{data: BodyType<RegistrationFamilyUpdateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateRegistrationFamily>>, TError,{data: BodyType<RegistrationFamilyUpdateInput>}, TContext> => {

const mutationKey = ['updateRegistrationFamily'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateRegistrationFamily>>, {data: BodyType<RegistrationFamilyUpdateInput>}> = (props) => {
          const {data} = props ?? {};

          return  updateRegistrationFamily(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateRegistrationFamilyMutationResult = NonNullable<Awaited<ReturnType<typeof updateRegistrationFamily>>>
    export type UpdateRegistrationFamilyMutationBody = BodyType<RegistrationFamilyUpdateInput>
    export type UpdateRegistrationFamilyMutationError = ErrorType<unknown>

    /**
 * @summary Update shared family and guardian details for a set of registrations
 */
export const useUpdateRegistrationFamily = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateRegistrationFamily>>, TError,{data: BodyType<RegistrationFamilyUpdateInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateRegistrationFamily>>,
        TError,
        {data: BodyType<RegistrationFamilyUpdateInput>},
        TContext
      > => {
      return useMutation(getUpdateRegistrationFamilyMutationOptions(options));
    }
...
export const updateRegistrationCustomAnswers = async (registrationId: number,
  ...
  return customFetch<UpdateRegistrationCustomAnswers200>(getUpdateRegistrationCustomAnswersUrl(registrationId),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(updateCustomAnswersInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListRoomsQueryKey(eventId);
   ...
   return  { queryKey, queryFn, enabled: eventId !== null && eventId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listRooms>>, TError, TData> & { queryKey: QueryKey }
}
...
export const createRegistrationGroup = async (createRegistrationGroupInput: CreateRegistrationGroupInput, options?: RequestInit): Promise<RegistrationGroup> => {
  ...
  return customFetch<RegistrationGroup>(getCreateRegistrationGroupUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(createRegistrationGroupInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetChildQueryKey(childId);
   ...
   return  { queryKey, queryFn, enabled: childId !== null && childId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getChild>>, TError, TData> & { queryKey: QueryKey }
}
...
export const bulkCheckout = async (bulkCheckoutInput: BulkCheckoutInput, options?: RequestInit): Promise<BulkCheckoutResult> => {
  ...
  return customFetch<BulkCheckoutResult>(getBulkCheckoutUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(bulkCheckoutInput)
  }
);}
...
export const batchCheckin = async (batchCheckinInput: BatchCheckinInput, options?: RequestInit): Promise<BatchCheckinResult> => {
  ...
  return customFetch<BatchCheckinResult>(getBatchCheckinUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(batchCheckinInput)
  }
);}
...
export const updateCheckin = async (checkinId: number,
  ...
  return customFetch<CheckIn>(getUpdateCheckinUrl(checkinId),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(updateCheckinInput)
  }
);}
...
export const createEventCategory = async (createEventCategoryInput: CreateEventCategoryInput, options?: RequestInit): Promise<EventCategory> => {
  ...
  return customFetch<EventCategory>(getCreateEventCategoryUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(createEventCategoryInput)
  }
);}
...
export const updateEventCategory = async (categoryId: number,
  ...
  return customFetch<EventCategory>(getUpdateEventCategoryUrl(categoryId),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(updateEventCategoryInput)
  }
);}
...
export const getSeedTestDataUrl = () => {




  return `/api/admin/seed-test-data`
}

/**
 * @summary Create 3 demo events (child check-in, family/group, individual) with rooms and sample registrants
 */
export const seedTestData = async ( options?: RequestInit): Promise<SeedTestDataResult> => {

  return customFetch<SeedTestDataResult>(getSeedTestDataUrl(),
  {
    ...options,
    method: 'POST'
...
export const getSeedTestDataMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof seedTestData>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof seedTestData>>, TError,void, TContext> => {

const mutationKey = ['seedTestData'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof seedTestData>>, void> = () => {


          return  seedTestData(requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SeedTestDataMutationResult = NonNullable<Awaited<ReturnType<typeof seedTestData>>>

    export type SeedTestDataMutationError = ErrorType<unknown>

    /**
 * @summary Create 3 demo events (child check-in, family/group, individual) with rooms and sample registrants
 */
export const useSeedTestData = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof seedTestData>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof seedTestData>>,
        TError,
        void,
        TContext
      > => {
      return useMutation(getSeedTestDataMutationOptions(options));
    }
