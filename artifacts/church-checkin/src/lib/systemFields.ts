...
const GUARDIAN_FIELDS: SystemFieldDef[] = [
  ...
  {
    key: "secondary_guardian_first_name",
    label: "Secondary Parent / Guardian First Name",
    fieldType: "text",
    category: "guardian",
    dbColumn: "registrations.secondary_guardian_first_name",
    placeholder: "First name",
  },
  {
    key: "secondary_guardian_last_name",
    label: "Secondary Parent / Guardian Last Name",
    fieldType: "text",
    category: "guardian",
    dbColumn: "registrations.secondary_guardian_last_name",
    placeholder: "Last name",
  },
  {
    ...
    fieldType: "phone",
    category: "guardian",
    dbColumn: "registrations.secondary_guardian_phone",
    placeholder: "(555) 000-0000",
  },
  {
    key: "secondary_guardian_email",
    label: "Secondary Parent / Guardian Email",
    fieldType: "email",
    category: "guardian",
    dbColumn: "registrations.secondary_guardian_email",
    placeholder: "email@example.com",
  },
  {
    key: "secondary_guardian_relationship",
    label: "Secondary Parent / Guardian Relationship",
    fieldType: "text",
    category: "guardian",
    dbColumn: "registrations.secondary_guardian_relationship",
