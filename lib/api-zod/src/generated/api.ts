...
export const ListFormsResponseItem = zod.object({
  ...
  "requireStartButton": zod.boolean().optional(),
  ...
  "sectionTitles": zod.record(zod.string(), zod.string()).optional(),
...
export const ListEventsResponseItem = zod.object({
  ...
  "customDates": zod.array(zod.string()).optional(),
...
export const CreateEventBody = zod.object({
  ...
  "customDates": zod.array(zod.string().regex(/^\d{4}-\d{2}-\d{2}$/)).min(1).optional(),
